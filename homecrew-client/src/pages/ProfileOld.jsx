...
const Profile = () => {
  ...
  const inputCls = "w-full px-4 py-3 border border-gray-300 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 transition";
        ...
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <div className="w-full lg:w-72 bg-white rounded-3xl shadow-lg p-6 border border-gray-100 hover:shadow-xl transition-shadow duration-300">
            ...
            <div className="relative mb-6">
              <div className="absolute inset-0 bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 rounded-2xl blur opacity-30"></div>
              <div className="relative bg-white rounded-2xl p-5 border-2 border-gradient">
                <div className="flex items-center gap-4">
                  <div className="relative">
                    <div className="w-16 h-16 rounded-full overflow-hidden ring-4 ring-indigo-100 flex-shrink-0">
                      {profileImagePreview ? (
                        <img src={profileImagePreview} alt="Profile" className="w-full h-full object-cover" />
                      ) : (
                        <div className="w-full h-full bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 flex items-center justify-center text-white text-xl font-bold">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <span className="inline-block px-2 py-1 bg-gradient-to-r from-indigo-500 to-purple-500 text-white text-xs font-semibold rounded-full mt-1">
                      {profile.role}
                    </span>
                  </div>
                </div>
              ...
              <div className="bg-white rounded-3xl shadow-lg p-8 border border-gray-100">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="bg-gradient-to-br from-indigo-50 to-purple-50 rounded-2xl p-5 border border-indigo-100">
                    <label className="block text-xs font-semibold text-indigo-600 mb-2 uppercase tracking-wide">Full Name</label>
                    <p className="text-gray-800 text-lg font-semibold">{profile.first_name} {profile.last_name}</p>
                  </div>
                  <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-2xl p-5 border border-blue-100">
                    <label className="block text-xs font-semibold text-blue-600 mb-2 uppercase tracking-wide">Email</label>
                  ...
                  <div className="bg-gradient-to-br from-pink-50 to-rose-50 rounded-2xl p-5 border border-pink-100 md:col-span-2">
                    <label className="block text-xs font-semibold text-pink-600 mb-2 uppercase tracking-wide">Bio</label>
                    <p className="text-gray-800 font-medium">{profile.bio || 'No bio provided'}</p>
                  </div>
                  <div className="bg-gradient-to-br from-purple-50 to-violet-50 rounded-2xl p-5 border border-purple-100 md:col-span-2">
                    <label className="block text-xs font-semibold text-purple-600 mb-2 uppercase tracking-wide">Member Since</label>
              ...
              <div className="bg-white rounded-3xl shadow-lg p-8 border border-gray-100">
                ...
                {orders.length === 0 ? (
                  ...
                  <div className="space-y-4">
                    {orders.map(order => (
                      <div key={order.id} className="relative group bg-gradient-to-br from-gray-50 to-white border-2 border-gray-200 rounded-2xl p-6 hover:border-indigo-300 hover:shadow-xl transition-all duration-300">
                        ...
                        {order.items && (
                          ...
                          <div className="flex gap-3 mt-4">
                            <button
                              ...
                              className="flex-1 px-4 py-2.5 text-white bg-gradient-to-r from-indigo-600 to-purple-600 rounded-xl hover:from-indigo-700 hover:to-purple-700 font-semibold text-sm shadow-md hover:shadow-lg transition-all"
                            >
                              View Details
                            </button>
              ...
              <div className="bg-white rounded-3xl shadow-lg p-8 border border-gray-100">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="bg-gradient-to-br from-indigo-50 to-purple-50 rounded-2xl p-6 border-2 border-dashed border-indigo-200">
                    <label className="block text-sm font-bold text-indigo-700 mb-4 uppercase tracking-wide">Profile Picture</label>
                    <div className="flex flex-col md:flex-row items-center gap-6">
                      <div className="relative">
                        <div className="w-28 h-28 rounded-full overflow-hidden ring-4 ring-indigo-200 shadow-lg">
                          {profileImagePreview ? (
                      ...
                      <div className="flex-1 text-center md:text-left">
                        ...
                        <label
                          htmlFor="profile_pic"
                          className="cursor-pointer inline-block px-6 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white font-bold rounded-xl transition-all shadow-md hover:shadow-lg hover:scale-105"
                        >
                          Choose New Image
                        </label>
                        <p className="text-xs text-gray-600 mt-3">PNG, JPG or JPEG (Max 5MB)</p>
                        <p className="text-xs text-indigo-600 font-semibold mt-1">Recommended: 400x400px</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <input
                        ...
                        required
                        className="w-full px-4 py-3 rounded-xl border-2 border-gray-200 focus:border-indigo-500 focus:ring-4 focus:ring-indigo-100 transition-all outline-none font-medium"
                      />
                    </div>
                    <div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full px-4 py-3 rounded-xl border-2 border-gray-200 focus:border-indigo-500 focus:ring-4 focus:ring-indigo-100 transition-all outline-none font-medium resize-none"
                    />
                  </div>
                  <div>
                  ...
                  <button type="submit" className="w-full flex items-center justify-center gap-2 px-6 py-4 bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 hover:from-indigo-700 hover:via-purple-700 hover:to-pink-700 text-white font-bold rounded-xl transition-all shadow-lg hover:shadow-xl hover:scale-105">
            ...
            {activeTab === 'change-password' && (
              <div className="bg-white rounded-3xl shadow-lg p-8 border border-gray-100">
                ...
                <form onSubmit={handlePasswordChange} className="space-y-6 max-w-md">
                  ...
                  <button type="submit" className="w-full flex items-center justify-center gap-2 px-6 py-4 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white font-bold rounded-xl transition-all shadow-md hover:shadow-lg hover:scale-105">
            ...
            {activeTab === 'reset-password' && (
              <div className="bg-white rounded-3xl shadow-lg p-8 border border-gray-100">
                ...
                <form onSubmit={handlePasswordReset} className="space-y-6 max-w-md">
                  ...
                  <button type="submit" className="w-full flex items-center justify-center gap-2 px-6 py-4 bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 text-white font-bold rounded-xl transition-all shadow-md hover:shadow-lg hover:scale-105">
