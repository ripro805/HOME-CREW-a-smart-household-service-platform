              ...
              {order.can_pay ? (
                ...
                <div className="space-y-4">
                  ...
                  {order.status !== 'CANCELLED' && (
                    <button
                      onClick={() => navigate(`/orders/${order.id}/track-technician`)}
                      className="w-full border-2 border-teal-600 text-teal-700 hover:bg-teal-50 font-bold py-3.5 px-6 rounded-xl transition-colors"
                    >
                      🛠️ Track Technician
                    </button>
                  )}
